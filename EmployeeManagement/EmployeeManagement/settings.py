...
SECRET_KEY = 'django-insecure-#cc34(xhp&@y2$a#t5qu7zqrxeyu2&+0i5fqd8v=c8mgt1u5kq'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'employeeregister',    # Replace 'your_database_name' with the name of your MySQL database
